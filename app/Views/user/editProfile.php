...
<div class="container-fluid">
   ...
   <div class="container-fluid">
      ...
      <!-- User Card Details -->
                     ...
                     <div class="card-body">
                        <div class="card-body">
                           <ul class="list-group list-group-flush">
                              ...
                              <li class="list-group-item"><small><a href="<?= base_url('/user'); ?>">&laquo; Back To My Profile</a></small></li>
                           </ul>
                        </div>
                     </div>
                  </div>
         ...
         <!-- Update User -->
         <div class="col-md-6">
            <form action="<?= base_url('user/updateUser/' . $user->userid) ?>" method="post" enctype="multipart/form-data">
               <?= csrf_field() ?>
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="modal-body">
            <form action="<?= base_url('user/updatePass/' . $user->userid . '/') ?>" method="post">
               <?= csrf_field() ?>
               <!-- Password Lama -->
               <div class="form-group">
                  <label for="old_password">Password Lama</label>
                  <input type="password" class="form-control <?= $validation->hasError('old_password') ? 'is-invalid' : (!old('old_password') ? '' : 'is-valid'); ?>" placeholder="Password Lama" autocomplete="off" name="old_password">
                  <div class="invalid-feedback">
